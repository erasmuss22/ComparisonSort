// Copyright 2010-2011 Beck Hasti and Ben Liblit. All rights reserved.

/**
 * A SortObject is essentially an integer wrapper class that keeps track of the
 * number of comparisons that are done on SortObjects.
 * 
 * @author Beck Hasti <hasti@cs.wisc.edu>
 * @author Ben Liblit <liblit@cs.wisc.edu>
 * 
 */
public class SortObject implements Comparable<SortObject> {
     ...
     * 
     * @param data
     *            the integer value for this object
     */
    ...
    /**
     * Compares this SortObject to the one given and increments the comparison
     * counter.
     * 
     * @param other
